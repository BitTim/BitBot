...
var memes = JSON.parse(fs.readFileSync("./data/music.json", "utf8"));

module.exports = {
  name: "music",
  description: "Plays quality music",
  exec(msg, args)
  {
    if(args < 2)
    {
      msg.channel.send("❌ You have to specify a song title");
      return;
    }
    ...
    else if(args[1] === "list")
    {
      ...
      embed.addField("Songs", embedString);
    ...
    else if(args[1] === "rand")
    {
      ...
      msg.channel.send("🎲 Your Song: \"" + args[1] + "\"");
    }
